...
<h2><?php  __('Body');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $body['Body']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $body['Body']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Body', true), array('action' => 'edit', $body['Body']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Body', true), array('action' => 'delete', $body['Body']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $body['Body']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Bodies', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Body', true), array('action' => 'add')); ?> </li>
